...
<body>
    ...
    <section id="testimonios">
        <div class="container">
            <h2 class="title__primary">¡Gracias Profesor Claudio!</h2>
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <p class="desc">
                            Execelente profesor, a pesar de su salud iba a dictar clase.
                        </p>
                        <div class="person">
                            <span class="author">
                                Julieta Alegre
                    ...
                    <div class="swiper-slide">
                        <p class="desc">
                                Resumiría mi experiencia vivida como muy intensa, gratificante. 
                                Me llevo muy lindos recuerdos, y ojalá pueda plasmar todo lo aprendido con Claudio.
                        </p>
                        <div class="person">
                            <span class="author">
                                Daniel Orti
                    ...
                    <div class="swiper-slide">
                        <p class="desc">
                            Quería agradecer por todo lo transmitido y su dedicación tanto en las clases como por fuera de ellas. 
                            Estoy muy contento por todo lo que aprendo y lo que sigo aprendiendo. Gracias Claudio!
                        </p>
                        <div class="person">
                            <span class="author">
                                Nicolas Manueli
                    ...
                    <div class="swiper-slide">
                        <p class="desc">
                          Ha sido un gusto capacitarme con Claudio. Estoy muy feliz de haberlo conocido!!!.
                        </p>
                        <div class="person">
                            <span class="author">
                               Ezequiel Baldini
